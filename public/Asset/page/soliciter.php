    ...
    <main class="main-form">
        <section>
            <form action="traitement_PageContact.php" method="post" id="form-contact-global">
                ...
                <div class="form-adresse" style="display:none;">
                    <h2>Adresse</h2>
                ...
                <div class="form-contact-message" style="display:none;">
                    ...
                    <button type="button" id="etape-contact">Étape suivante</button>
                    <button type="button" id="retour2">Retour</button>
                </div>

                <div class="recapitulatif" style="display:none;">
                    <h2>Récapitulatif</h2>
                    <ul>
