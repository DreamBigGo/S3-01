...
<nav class="menu">
    ...
    <a href="/Asset/page/Mission.php" class="<?= ($currentPage == 'quisommenous.php') ? 'active' : '' ?>">Mission</a>
    <a href="/Asset/page/GererMembre.php" class="<?= ($currentPage == 'actionfrance.php') ? 'active' : '' ?>">Gerer Membre</a>
...
<nav class="nav-cache">
    <a href="/index.php" class="<?= ($currentPage == 'index.php') ? 'active' : '' ?>">Accueil</a>
    <a href="/Asset/page/Mission.php" class="<?= ($currentPage == 'quisommenous.php') ? 'active' : '' ?>">Qui sommes-nous</a>
    <a href="/Asset/page/GererMembre.php" class="<?= ($currentPage == 'actionfrance.php') ? 'active' : '' ?>">Action France</a>
